...
public class TileDissector {
    ...
    public static Color[][] getBotRect(int height, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        ArrUtil.retainByPredicate(raw, (x, y) -> y > h_org - height - fadeLength);
        if (fade) ArrUtil.fade(raw, interpolator, 0, h_org - height, 0, h_org - height - fadeLength);
        if (deNull) ArrUtil.deNull(raw, Color.INVISIBLE);
        return raw;
    }
    ...
    public static Color[][] getLefRect(int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        if (fade) ArrUtil.fade(raw, interpolator, width, 0, width + fadeLength, 0);
        if (deNull) ArrUtil.deNull(raw, Color.INVISIBLE);
        return raw;
    }
    ...
    public static Color[][] getRigRect(int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        ArrUtil.retainByPredicate(raw, (x, y) -> x > w_org - width - fadeLength);
        if (fade) ArrUtil.fade(raw, interpolator, w_org - width, 0, w_org - width - fadeLength, 0);
        if (deNull) ArrUtil.deNull(raw, Color.INVISIBLE);
        return raw;
    }
    ...
    public static Color[][] getHorRect(int h_abv, int h_blw, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int h_org_2 = raw[0].length / 2;
        ArrUtil.retainByPredicate(raw, (x, y) -> y > h_org_2 - h_abv - fadeLength && y < h_org_2 + h_blw + fadeLength);
        if (fade) {
            ArrUtil.fade(raw, interpolator, 0, h_org_2 - h_abv, 0, h_org_2 - h_abv - fadeLength);
            ArrUtil.fade(raw, interpolator, 0, h_org_2 + h_blw, 0, h_org_2 + h_blw + fadeLength);
        }
        if (deNull) ArrUtil.deNull(raw, Color.INVISIBLE);
        return raw;
    }
    ...
    public static Color[][] getVerRect(int w_lef, int w_rig, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int w_org_2 = raw.length / 2;
        ArrUtil.retainByPredicate(raw, (x, y) -> x > w_org_2 - w_lef - fadeLength && x < w_org_2 + w_rig + fadeLength);
        if (fade) {
            ArrUtil.fade(raw, interpolator, w_org_2 - w_lef, 0, w_org_2 - w_lef - fadeLength, 0);
            ArrUtil.fade(raw, interpolator, w_org_2 + w_rig, 0, w_org_2 + w_rig + fadeLength, 0);
        }
        if (deNull) ArrUtil.deNull(raw, Color.INVISIBLE);
        return raw;
    }
    ...
    public static Color[][] getRect(int h_abv, int h_blw, int w_lef, int w_rig, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        int h_org_2 = raw[0].length / 2;
        int w_org_2 = raw.length / 2;
        ArrUtil.retainByPredicate(raw, (x, y) ->
                /**/ y > h_org_2 - h_abv - fadeLength && y < h_org_2 + h_blw + fadeLength &&
                /**/ x > w_org_2 - w_lef - fadeLength && x < w_org_2 + w_rig + fadeLength);
        if (fade) {
            ArrUtil.fade(raw, interpolator, 0, h_org_2 - h_abv, 0, h_org_2 - h_abv - fadeLength);
            ArrUtil.fade(raw, interpolator, 0, h_org_2 + h_blw, 0, h_org_2 + h_blw + fadeLength);
            ArrUtil.fade(raw, interpolator, w_org_2 - w_lef, 0, w_org_2 - w_lef - fadeLength, 0);
    ...
    public static Color[][] getTopRigRect(int width, int height, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int w_org = raw.length;
        ArrUtil.retainByPredicate(raw, (x, y) -> y < height + fadeLength && x > w_org - width - fadeLength);
        if (fade) {
            ArrUtil.fade(raw, interpolator, 0, height, 0, height + fadeLength);
    ...
    public static Color[][] getBotLefRect(int width, int height, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int h_org = raw[0].length;
        ArrUtil.retainByPredicate(raw, (x, y) -> y > h_org - height - fadeLength && x < width + fadeLength);
        if (fade) {
            ArrUtil.fade(raw, interpolator, 0, h_org - height, 0, h_org - height - fadeLength);
            ArrUtil.fade(raw, interpolator, width, 0, width + fadeLength, 0);
        }
        if (deNull) ArrUtil.deNull(raw, Color.INVISIBLE);
        return raw;
    ...
    public static Color[][] getBotRigRect(int width, int height, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        int w_org = raw.length;
        int h_org = raw[0].length;
        ArrUtil.retainByPredicate(raw, (x, y) -> y > h_org - height - fadeLength && x > w_org - width - fadeLength);
        if (fade) {
            ArrUtil.fade(raw, interpolator, 0, h_org - height, 0, h_org - height - fadeLength);
            ArrUtil.fade(raw, interpolator, w_org - width, 0, w_org - width - fadeLength, 0);
        }
    ...
    public static Color[][] getTopTri(int x_c, int y_c, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        Line line2 = Line.fromTwoPoints(w_org, 0, x_c, y_c);
    ...
    public static Color[][] getTopTri(boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        ArrUtil.retainByPredicate(raw, (x, y) -> y < x + effectiveLength && x + y < w_org + effectiveLength);
        if (fade) {
            int w_2 = (int) (w_org / 2);
            int h_2 = (int) (h_org / 2);
            ArrUtil.fade(raw, interpolator, w_2, h_2, w_2 + effectiveLength, h_2 + effectiveLength);
            ArrUtil.fade(raw, interpolator, w_2, h_2, w_2 - effectiveLength, h_2 + effectiveLength);
        }
        if (deNull) ArrUtil.deNull(raw, Color.INVISIBLE);
        return raw;
    ...
    public static Color[][] getBotTri(int x_c, int y_c, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        Line line1 = Line.fromTwoPoints(0, h_org, x_c, y_c);
        Line line1FadeExtent = line1.clone();
        Line line2 = Line.fromTwoPoints(w_org, h_org, x_c, y_c);
        Line line2FadeExtent = line2.clone();
        line1FadeExtent.moveParallely(fadeLength, -5000, -5000);
        line2FadeExtent.moveParallely(fadeLength, +5000, -5000);
        ArrUtil.retainByPredicate(raw, (x, y) -> line1FadeExtent.put(x, y) < 0 && line2FadeExtent.put(x, y) < 0);
    ...
    public static Color[][] getBotTri(boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        int effectiveLength = (int) (fadeLength * AppUtil.ROOT_2);
        ArrUtil.retainByPredicate(raw, (x, y) -> x < y + effectiveLength && x + y > w_org - effectiveLength);
        if (fade) {
            int w_2 = (int) (w_org / 2);
            int h_2 = (int) (h_org / 2);
            ArrUtil.fade(raw, interpolator, w_2, h_2, w_2 + effectiveLength, h_2 - effectiveLength);
    ...
    public static Color[][] getLefTri(int x_c, int y_c, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        Line line1 = Line.fromTwoPoints(0, 0, x_c, y_c);
        Line line1FadeExtent = line1.clone();
        Line line2 = Line.fromTwoPoints(0, h_org, x_c, y_c);
        Line line2FadeExtent = line2.clone();
        line1FadeExtent.moveParallely(fadeLength, 5000, -5000);
        line2FadeExtent.moveParallely(fadeLength, 5000, +5000);
        ArrUtil.retainByPredicate(raw, (x, y) -> line1FadeExtent.put(x, y) > 0 && line2FadeExtent.put(x, y) > 0);
    ...
    public static Color[][] getRigTri(int x_c, int y_c, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        Line line1 = Line.fromTwoPoints(w_org, 0, x_c, y_c);
        Line line1FadeExtent = line1.clone();
        Line line2 = Line.fromTwoPoints(w_org, h_org, x_c, y_c);
        Line line2FadeExtent = line2.clone();
        line1FadeExtent.moveParallely(fadeLength, -5000, -5000);
    ...
    public static Color[][] getTopLefTri(int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        if (fade) ArrUtil.fade(raw, interpolator, width, 0, width + effectiveLength, effectiveLength);
    ...
    public static Color[][] getTopRigTri(int width, int height, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        Line line = Line.fromTwoPoints(w_org - width, 0, w_org, height);
        Line lineFadeExtent = line.clone();
        lineFadeExtent.moveParallely(fadeLength, -5000, 5000);
        ArrUtil.retainByPredicate(raw, (x, y) -> lineFadeExtent.put(x, y) < 0);
        if (fade) {
    ...
    public static Color[][] getTopRigTri(int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        ArrUtil.retainByPredicate(raw, (x, y) -> y < x - w_org + width + effectiveLength);
        if (fade) ArrUtil.fade(raw, interpolator, w_org - width, 0, w_org - width - effectiveLength, effectiveLength);
    ...
    public static Color[][] getBotLefTri(int width, int height, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        Line line = Line.fromTwoPoints(0, h_org - height, width, h_org);
        Line lineFadeExtent = line.clone();
        lineFadeExtent.moveParallely(fadeLength, 5000, -5000);
        ArrUtil.retainByPredicate(raw, (x, y) -> lineFadeExtent.put(x, y) > 0);
        if (fade) {
    ...
    public static Color[][] getBotLefTri(int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        ArrUtil.retainByPredicate(raw, (x, y) -> y > x + h_org - width - effectiveLength);
        if (fade) ArrUtil.fade(raw, interpolator, 0, h_org - width, effectiveLength, h_org - width - effectiveLength);
    ...
    public static Color[][] getBotRigTri(int width, int height, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        ...
        Line line = Line.fromTwoPoints(w_org - width, h_org, w_org, h_org - height);
        Line lineFadeExtent = line.clone();
        lineFadeExtent.moveParallely(fadeLength, -5000, -5000);
        ArrUtil.retainByPredicate(raw, (x, y) -> lineFadeExtent.put(x, y) < 0);
        if (fade) {
    ...
    /**
     * @param height       The height from top of original image to be used as the the abscissa of fourth point of the rectangle to be cropped.
     * @param width        The width from left of original image to be used as the the ordinate of fourth point of the rectangle to be cropped.
     * @param fade         If true, fades the image about the cuts by fadeLength.
     * @param fadeLength   The length by which the fade takes effect.
     * @param raw          If it's null, a new array is returned based on the original pixels taken in by the constructor. If it's not null, the effect os applied on this array.
     * @param interpolator The interpolator to be used to fade the pixels.
     ...
     * The dimensions remain the same, ie, the remaining pixels are Null or Transparent.
     */
    public static Color[][] getTopLefPoly(int height, int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int effectiveLength = (int) (fadeLength * AppUtil.ROOT_2);
     ...
     * The dimensions remain the same, ie, the remaining pixels are Null or Transparent.
     */
    public static Color[][] getLefTopPoly(int height, int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int effectiveLength = (int) (fadeLength * AppUtil.ROOT_2);
    ...
    /**
     * @param height       The height from top of original image to be used as the the abscissa of fourth point of the rectangle to be cropped.
     * @param width        The width from right of original image to be used as the the ordinate of fourth point of the rectangle to be cropped.
     * @param fade         If true, fades the image about the cuts by fadeLength.
     * @param fadeLength   The length by which the fade takes effect.
     * @param raw          If it's null, a new array is returned based on the original pixels taken in by the constructor. If it's not null, the effect os applied on this array.
     * @param interpolator The interpolator to be used to fade the pixels.
     ...
     * The dimensions remain the same, ie, the remaining pixels are Null or Transparent.
     */
    public static Color[][] getTopRigPoly(int height, int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int w_org = raw.length;
        int effectiveLength = (int) (fadeLength * AppUtil.ROOT_2);
        ArrUtil.retainByPredicate(raw, (x, y) -> y < height + fadeLength && y < x - w_org + width + height + effectiveLength);
        if (fade) {
            ArrUtil.fade(raw, interpolator, 0, height, 0, height + fadeLength);
     ...
     * The dimensions remain the same, ie, the remaining pixels are Null or Transparent.
     */
    public static Color[][] getRigTopPoly(int height, int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int w_org = raw.length;
        int effectiveLength = (int) (fadeLength * AppUtil.ROOT_2);
    ...
    /**
     * @param height       The height from bottom of original image to be used as the the abscissa of fourth point of the rectangle to be cropped.
     * @param width        The width from left of original image to be used as the the ordinate of fourth point of the rectangle to be cropped.
     * @param fade         If true, fades the image about the cuts by fadeLength.
     * @param fadeLength   The length by which the fade takes effect.
     * @param raw          If it's null, a new array is returned based on the original pixels taken in by the constructor. If it's not null, the effect os applied on this array.
     ...
     * The dimensions remain the same, ie, the remaining pixels are Null or Transparent.
     */
    public static Color[][] getBotLefPoly(int height, int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int h_org = raw[0].length;
        int effectiveLength = (int) (fadeLength * AppUtil.ROOT_2);
        ArrUtil.retainByPredicate(raw, (x, y) -> y > h_org - height - fadeLength && y > x + h_org - height - width - effectiveLength);
        if (fade) {
            ArrUtil.fade(raw, interpolator, 0, height, 0, height - fadeLength);
     ...
     * The dimensions remain the same, ie, the remaining pixels are Null or Transparent.
     */
    public static Color[][] getLefBotPoly(int height, int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int h_org = raw[0].length;
        int effectiveLength = (int) (fadeLength * AppUtil.ROOT_2);
     ...
     * The dimensions remain the same, ie, the remaining pixels are Null or Transparent.
     */
    public static Color[][] getBotRigPoly(int height, int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int w_org = raw.length;
        int h_org = raw[0].length;
        int effectiveLength = (int) (fadeLength * AppUtil.ROOT_2);
        ArrUtil.retainByPredicate(raw, (x, y) -> y > h_org - height - fadeLength && x + y > w_org - width + h_org - height - effectiveLength);
        if (fade) {
            ArrUtil.fade(raw, interpolator, 0, height, 0, height - fadeLength);
     ...
     * The dimensions remain the same, ie, the remaining pixels are Null or Transparent.
     */
    public static Color[][] getRigBotPoly(int height, int width, boolean fade, int fadeLength, Color[][] raw, FloatFunction interpolator, boolean clone, boolean deNull) {
        raw = arrayPreCheck(raw, clone);
        int w_org = raw.length;
        int h_org = raw[0].length;
        int effectiveLength = (int) (fadeLength * AppUtil.ROOT_2);
    ...
    private static Color[][] arrayPreCheck(Color[][] raw, boolean clone) {
        if (raw == null || raw[0] == null)
            throw new NullPointerException("The given array is null, or has null sub arrays.");
